...
const WeddingOf = () => {
    return (
        <div className="h-auto flex flex-col justify-around pt-6"
            style={{
                // display: "none"
            }}
        >
            {/* hero img */}
            <div className=" w-10/12 mx-auto hero-img flex justify-center items-end font-madeCanvas text-3xl leading-8 font-medium text-center">
